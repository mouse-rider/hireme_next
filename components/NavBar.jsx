        ...
        <>
            <div className={`w-full ${scrolled ? "bg-orange-600/70" : "bg-orange-600"} px-6 h-20 bg-orange-600 text-white flex items-center justify-between fixed top-0 left-0 z-50`}>
                <div className='px-2 h-full flex items-center justify-center'>
                    <p className='font-semibold tracking-widest text-lg'>HireMe!</p>
                </div>
                ...
                <div className='px-2 h-full hidden items-center justify-center lg:flex ' >
                    {
                        user !== null ? (
                            ...
                            <>
                                ...
                                <Link href={'/auth/register'} className='px-4 py-2 border border-white rounded uppercase tracking-widest mx-4   text-orange-600 bg-white transition-all duration-700 hover:bg-transparent font-semibold text-base hover:text-white'>REGISTER</Link>
                            </>
                        )
                    }
                ...
                {
                    isOpen && (
                        <div ref={ref} className='flex w-full py-2 animate-fade-in-down  bg-orange-600 transition-all fade duration-1000 absolute top-20 left-0  items-center justify-center flex-col '>
