  ...
  return (
    <>
      ...
      <Head>
        ...
        <meta name="author" content="Ryzaq Innovators KIOT" />
        <meta property="og:title" content="Hire Me! | KIOT" />
        <meta name="twitter:title" content="Hire Me! | KIOT" />
...

      {
        isLoading ? (
          <div className='bg-gray w-full h-screen flex items-center flex-col justify-center'>
            <InfinitySpin width='200' color="#1fc459"/>
